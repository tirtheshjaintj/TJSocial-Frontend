    ...
    return (
        <div ref={innerRef} className="bg-transparent">
            ...
            >
                ...
                <Carousel
                    slide={false}
                    className="hide-scrollbar overflow-y-hidden hide-scrollbar"
                    leftControl={
                ...
                {/* Footer with actions */}
                <div className="absolute bg-gray-50 dark:bg-gray-900 bottom-0 left-0 right-0  flex items-center justify-around py-3 px-4  dark:border-gray-700 ">
                    ...
                    <div className="flex items-center justify-center gap-1 h-8 text-green-600 dark:text-green-400 cursor-pointer hover:scale-110 border-2 border-l-0 rounded-r-lg flex-1 px-2 min-w-[64px]">
                        <FaRegShareSquare />
