...
export default function UserPage({ title }: titleProp) {
    usePageSetup(title);
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-8 gap-6">
                ...
                >
                    <div className="w-32 h-32 rounded-full bg-[url('/profile-default.webp')] bg-cover bg-no-repeat bg-center border-4 border-white dark:border-gray-800 shadow-lg -mt-30" />
                    <div className="mt-4">
                        <h2 className="text-xl md:text-2xl font-semibold text-gray-800 dark:text-white">
                            Tirthesh Jain
                        </h2>
                        <p className="text-sm md:text-md text-gray-600 dark:text-gray-400">@123{username}</p>
                    </div>
                </motion.div>
